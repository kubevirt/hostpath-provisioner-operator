...
func (c *HostpathprovisionerV1beta1Client) HostPathProvisioners() HostPathProvisionerInterface {
	return newHostPathProvisioners(c)
}

// NewForConfig creates a new HostpathprovisionerV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new HostpathprovisionerV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*HostpathprovisionerV1beta1Client, error) {
	...
	return &HostpathprovisionerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new HostpathprovisionerV1beta1Client for the given config and
...
func New(c rest.Interface) *HostpathprovisionerV1beta1Client {
	return &HostpathprovisionerV1beta1Client{c}
}
